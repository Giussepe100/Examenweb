...
<body>
    ...
    <div class="contenido">
        <div class="libros">
            <div class="portada">
                <a href="libros/libro-ojala.php" class="imagen-portada">
        ...
        <div class="libros">
            <div class="portada">
                <a href="libros/libro-metamorfosis.php" class="imagen-portada">
        ...
        <div class="libros">
            <div class="portada">
                <a href="libros/libro-crimen-y-castigo.php" class="imagen-portada">
        ...
        <div class="libros">
            <div class="portada">
                <a href="libros/libro-la-carretera.php" class="imagen-portada">
                    <img src="imagenes/lib4.jpg" class="imagen">
                </a>
            </div>
            <div class="links-libro">
                <a href="libros/libro-la-carretera.php" class="link-titulo">LA CARRETERA</a><br>
                <a href="biografíaautor.html" class="link-autor">Cormac McCarthy</a><br>
                <a href="libros/libro-la-carretera.php" class="btn">Previsualizar</a><br>
